...
// Screens
import ProfileScreen from './ProfileAdmin';
      ...
      screenOptions={({ route }) => ({
        ...
        tabBarIcon: ({ focused, color, size }) => {
          ...
          if (route.name === homeName) {
            ...
            iconSource = focused
              ? require('../assets/camera-active.png') // Add your active notification icon
              : require('../assets/camera-inactive.png'); // Add your inactive notification icon
